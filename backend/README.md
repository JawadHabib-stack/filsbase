<p align="center"><img src="https://user-images.githubusercontent.com/396987/82162573-6940f500-98c7-11ea-974e-888b4f866c74.jpg" alt="Filsbase - A CMS like modular starter project built with the latest Laravel framework."></p>

# Filsbase (based on Laravel 11.x)
**Filsbase** is a Laravel 11.x based simple starter project. Most of the commonly needed features of an application like `Authentication`, `Authorisation`, `Users` and `Role management`, `Application Backend`, `Backup`, `Log viewer` are available here. It is modular, so you may use this project as a base and build your own modules. A module can be used in any `Filsbase` based project.
Here Frontend and Backend are completely separated with separate routes, controllers, and themes as well.

***Please let me know your feedback and comments.***

[![Latest Stable Version](http://poser.pugx.org/Filsbase/laravel-starter/v)](https://packagist.org/packages/Filsbase/laravel-starter) [![StyleCI Build](https://github.styleci.io/repos/105638882/shield?style=flat)](https://packagist.org/packages/Filsbase/laravel-starter) [![License](http://poser.pugx.org/Filsbase/laravel-starter/license)](https://packagist.org/packages/Filsbase/laravel-starter) [![PHP Version Require](http://poser.pugx.org/Filsbase/laravel-starter/require/php)](https://packagist.org/packages/Filsbase/laravel-starter)
...
Several custom commands are available to add and update `role-permissions`. Please read the [Role - Permission Wiki page](https://github.com/Filsbase/laravel-starter/wiki/Role-Permission), where you will find the list of commands with examples.


# Features

The `Filsbase` comes with several features which are the most common in almost all applications. It is a template project which means it is intended to be built in a way that it can be used for other projects.
...
Follow the steps mentioned below to install and run the project. You may find more details about the installation in [Installation Wiki](https://github.com/Filsbase/laravel-starter/wiki/Installation).

1. Open the terminal and run the following command, this will download and install the `Filsbase` and run the post-installation commands. 
```bash
composer create-project Filsbase/laravel-starter
```
...
![Filsbase Homepage Dark Mode](https://github.com/Filsbase/laravel-starter/assets/396987/1cf5ce5a-f374-4bae-b5a3-69e8d7ff684d)
![Filsbase Homepage](https://github.com/Filsbase/laravel-starter/assets/396987/93341711-60dd-4624-8cd7-82f1c611287d)

__Login Page__

![Filsbase Login](https://user-images.githubusercontent.com/396987/164892620-3b4c8b1b-81c8-4630-a39f-38dadff89a7d.png)

__Posts Page__

![Filsbase Posts Page](https://github.com/Filsbase/laravel-starter/assets/396987/288f56cb-0cb0-4652-be17-9f65288558bb)

__Backend Dashboard__

![Filsbase Admin Dashboard Dark Mode](https://github.com/Filsbase/laravel-starter/assets/396987/0f6b8201-6f6a-429f-894b-4e491cc5eba4)
![Filsbase Admin Dashboard](https://github.com/Filsbase/laravel-starter/assets/396987/f8131011-2ecc-4a11-961f-85e02cb8f7a1)

---

![Filsbase Posts List](https://github.com/Filsbase/laravel-starter/assets/396987/c032769e-78b2-4dbf-bc5e-687645125796)

---

![Edit-Posts-Laravel-Starter](https://github.com/Filsbase/laravel-starter/assets/396987/6421b8e5-3c69-4c1f-9518-875e72be77c0)
