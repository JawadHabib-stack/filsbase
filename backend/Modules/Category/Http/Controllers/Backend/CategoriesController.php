...
class CategoriesController extends BackendBaseController
{
    ...
    public function index_data()
    {
        ...
        $query = $module_model::select('id', 'name', 'group_name', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            ...
            compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_name_singular', 'module_action', 'group_name')
        );
    }
