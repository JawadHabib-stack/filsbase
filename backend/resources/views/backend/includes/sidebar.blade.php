        ...
        <li class="nav-group" aria-expanded="true">
            ...
            <ul class="nav-group-items compact" style="height: auto">
                ...
                @php
                    ...
                    $text = __("Post Categories");
                    $icon = "fa-solid fa-diagram-project";
                    $permission = "view_" . $module_name;
                    $url = route("backend." . $module_name . ".index", ["group_name" => "Post"]);
                @endphp
                <x-backend.sidebar-nav-item :permission="$permission" :url="$url" :icon="$icon" :text="$text" />
            </ul>
        </li>
        ...
        <li class="nav-group" aria-expanded="true">
            ...
            <ul class="nav-group-items compact" style="height: auto">
                ...
                @php
                    ...
                    $icon = "fa-solid fa-diagram-project";
                    $permission = "view_" . $module_name;
                    $url = route("backend." . $module_name . ".index", ["group_name" => "Product"]);
                @endphp
                <x-backend.sidebar-nav-item :permission="$permission" :url="$url" :icon="$icon" :text="$text" />
            </ul>
        </li>
