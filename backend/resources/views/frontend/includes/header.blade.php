<div class="bg-gray-100 py-2 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
    <div class="mx-auto flex max-w-screen-xl items-center justify-between px-4 text-xs font-medium text-gray-600 dark:text-gray-400">
        ...
        <div class="flex items-center space-x-4">
            <a href="{{ route('frontend.users.profile') }}" class="flex items-center hover:text-blue-600 transition-colors">
                <i class="fas fa-user-circle me-1 text-sm"></i> Client Area
            </a>
            <span class="hidden sm:block text-gray-300 dark:text-gray-600">|</span>
            <span class="hidden sm:block"><i class="fas fa-headset me-1"></i> Support: +1 234 567 890</span>
        </div>
    </div>
</div>
